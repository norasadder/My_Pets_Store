...
public class ProfileController implements Initializable {
    ...
    public void save(ActionEvent event) throws IOException {
        ...
        Unit u = new Unit();
        //Connection con = u.oracleConnect();
...
//            Connection con = u.oracleConnect();
            ...
            String searchStr = "select FName , LName ,City , Street , Near , PNumber ,BDate , Email , userPassword From Customer where UserID =" + CustomerID;
